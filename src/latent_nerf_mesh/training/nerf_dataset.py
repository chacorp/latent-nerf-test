...
class NeRFDataset:
    ...
    def collate(self, index):
        ...
        if self.training:
            ...
            poses, dirs, thetas, phis, radius = rand_poses(B, self.device, radius_range=self.radius_range,
            ...
            theta = 80
            poses, dirs, thetas, phis, radius = circle_poses(self.device, radius=self.radius_range[1] * 1.2, theta=theta, phi=phi,

...
from .render_config import RenderConfig, MeshConfig
...
class TrainConfig:
    ...
    # for mesh
    guide_mesh: GuideConfigMesh = field(default_factory=GuideConfigMesh)
    optim_mesh: OptimConfigMesh = field(default_factory=OptimConfigMesh)
